...
{
    public class AddShipping_MethodValidator : AbstractValidator<AddShipping_MethodCommand>
    {
        #region Fields
        ...
        #region Constructors
        public AddShipping_MethodValidator(IShipping_MethodService shipping_MethodService, IStringLocalizer<SharedResources> localizer)
        {
        ...
        {
            RuleFor(x => x.Method_Name)
               .MustAsync(async (Key, CancellationToken) => !await _shipping_MethodService.IsNameExist(Key))
