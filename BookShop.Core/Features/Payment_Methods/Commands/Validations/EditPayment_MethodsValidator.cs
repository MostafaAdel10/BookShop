...
{
    public class EditPayment_MethodsValidator : AbstractValidator<EditPayment_MethodsCommand>
    {
        #region Fields
        ...
        #region Constructors
        public EditPayment_MethodsValidator(IStringLocalizer<SharedResources> localizer)
        {
