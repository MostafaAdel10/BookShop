...
{
    public class AddOrder_StateValidator : AbstractValidator<AddOrder_StateCommand>
    {
        #region Fields
        ...
        #region Constructors
        public AddOrder_StateValidator(IOrder_StateService order_StateService, IStringLocalizer<SharedResources> localizer)
        {
